    ...
    <footer className="bg-navy text-white py-12 px-4">
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div>
            <h3 className="text-2xl font-bold mb-2">Cedrick Manzanilla</h3>
            <p className="text-gray-300">
              Full-Stack Developer & UGC Video Editor
            </p>
            <a
              href="https://www.onlinejobs.ph/jobseekers/info/2966139"
              target="_blank"
              rel="noopener noreferrer"
              className="text-blue-300 hover:text-blue-200 mt-2 inline-block transition-colors"
            >
              View on OnlineJobs.ph →
            </a>
          </div>
